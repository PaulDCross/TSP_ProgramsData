...
!//Robot configuration
PERS tooldata currentTool:=[TRUE,[[20,0,180],[1,0,0,0]],[0.95,[18,0,140],[1,0,0,0],0,0,0]];
...
PERS string ipController:= "164.11.72.240"; !robot default IP
...
!// - Speed.
PROC Initialize()
    currentTool := [TRUE,[[20,0,180],[1,0,0,0]],[0.95,[18,0,140],[1,0,0,0],0,0,0]];    
