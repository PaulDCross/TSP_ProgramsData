...
groupedData = [list(j) for i,j in groupby(sortedData, key=lambda l: l['Pin'])]      # Group sorted data
groupedgroupedData = [list(j) for i,j in groupby(groupedData, key=lambda l: l[16])]
