...
!//Robot configuration
PERS tooldata currentTool:=[TRUE,[[20,0,233.7],[1,0,0,0]],[1.23,[27.5,0,155],[1,0,0,0],0,0,0]];
...
PERS string ipController:= "164.11.72.225"; !robot default IP
...
!// - Speed.
PROC Initialize()
    currentTool := [TRUE,[[20,0,233.7],[1,0,0,0]],[1.23,[27.5,0,155],[1,0,0,0],0,0,0]];    
