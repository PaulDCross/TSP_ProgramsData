...
ztool          = 167.5
zcoordinate    = 342.5
directory      = os.path.join("PinDataResults", "NewPillowRotationTestsTypeSignReset", "RotationTest{0}".format(ztool))
makedir(directory)
DIR            = os.path.join("TSP_Pictures", "RotationTests", "RotationTest{0}".format(ztool), "{0}mm".format(zcoordinate))
