...
ztool          = 130.0
zcoordinate    = "380.0mm"
directory      = os.path.join("PinDataResults", "RotationTestsSign", "RotationTest{0}".format(ztool))
makedir(directory)
    ...
    if True:
            for single in range(2):
                ...
                if Graph:
                    ...
                    labes3 = [float(i[:-3])/10 for i in label3]

                    best_fit = plt.plot(labes3, labes3, 'r-', label="Correct Classification")
